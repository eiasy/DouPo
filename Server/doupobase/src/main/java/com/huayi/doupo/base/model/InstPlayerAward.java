...
public class InstPlayerAward implements Serializable
{
	private int index;
	...
	*/
	...
	/**
		名目 1-天焚炼气塔  2-竞技场 3-系统 4-世界Boss
	*/
	private int name;
	public int getName(){
		return name;
	...
	public void setName(int name, int bs) {
		this.name = name;
	}
	...
	*/
	...
	public InstPlayerAward clone(){
		InstPlayerAward extend=new InstPlayerAward();
