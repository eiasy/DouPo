...
public class DictActivityMonthCardStoreTemp implements Serializable
{
	private int index;
	...
	*/
	...
	public DictActivityMonthCardStoreTemp clone(){
		DictActivityMonthCardStoreTemp extend=new DictActivityMonthCardStoreTemp();
