...
public class DictBarrierCard implements Serializable
{
	private int index;
	...
	*/
	...
	/**
		副本关卡等级Id
	*/
	private int barrierLevelId;
	public int getBarrierLevelId(){
		return barrierLevelId;
	}
	public void setBarrierLevelId(int barrierLevelId) {
		this.barrierLevelId = barrierLevelId;
		index = 2;
		result += index + "*int*" + barrierLevelId + "#";
	}

	public void setBarrierLevelId(int barrierLevelId, int bs) {
		this.barrierLevelId = barrierLevelId;
	}
	...
	*/
	...
	public DictBarrierCard clone(){
		DictBarrierCard extend=new DictBarrierCard();
		extend.setId(this.id);
		extend.setBarrierLevelId(this.barrierLevelId);
