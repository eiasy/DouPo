...
public class InstPlayerAchievementValue implements Serializable
{
	private int index;
	...
	*/
	...
	public InstPlayerAchievementValue clone(){
		InstPlayerAchievementValue extend=new InstPlayerAchievementValue();
