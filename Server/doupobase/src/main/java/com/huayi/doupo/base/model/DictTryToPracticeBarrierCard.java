...
public class DictTryToPracticeBarrierCard implements Serializable
{
	private int index;
	...
	*/
	...
	/**
		试练日字典Id
	*/
	private int tryToPracticeId;
	public int getTryToPracticeId(){
		return tryToPracticeId;
	}
	public void setTryToPracticeId(int tryToPracticeId) {
		this.tryToPracticeId = tryToPracticeId;
		index = 2;
		result += index + "*int*" + tryToPracticeId + "#";
	}

	public void setTryToPracticeId(int tryToPracticeId, int bs) {
		this.tryToPracticeId = tryToPracticeId;
	}
	...
	*/
	...
	public DictTryToPracticeBarrierCard clone(){
		DictTryToPracticeBarrierCard extend=new DictTryToPracticeBarrierCard();
		extend.setId(this.id);
		extend.setTryToPracticeId(this.tryToPracticeId);
