...
public class InstPlayer implements Serializable {
	...
	*/
	...
	public String toString() {
		return "玩家信息 [ID=" + id + ", OpenId=" + openId + ", 名称=" + name + ", 等级=" + level + ", 元宝=" + gold + ", 铜币=" + copper + ", 经验=" + exp + ", 体力=" + energy + ", 最大体力=" + maxEnergy + ", 耐力=" + vigor + ", 最大耐力=" + maxVigor + ", 可上阵卡牌数=" + cardNum + ", 最大上阵卡牌数=" + maxCardNum + ", 引导步骤=" + guidStep + ", 章节Id=" + chapterId + ", 关卡Id=" + barrierId + ", 异火抓取规则Id=" + fireGainRuleId + ", 玩家异火实例Id=" + instPlayerFireId + ", vip等级=" + vipLevel + ", 元气=" + vigour + ", 火能=" + culture + ", 上一次体力恢复时间=" + lastEnergyRecoverTime + ", 上一次耐力恢复时间=" + lastVigorRecoverTime + ", 副本战斗胜利次数=" + barrierNum + ", 当日购买体力的次数=" + buyEnergyNum + ", 当日购买耐力的次数=" + buyVigorNum + ", 最后一次购买体力的时间=" + lastBuyEnergyTime + ", 最后一次购买耐力的时间=" + lastBuyVigorTime + ", 关卡引导步骤=" + guipedBarrier + ", 洗澡恢复体力时间=" + washTime + ", 每日任务时间=" + dailyTashTime + ", 头像卡牌Id=" + headerCardId + ", 已领取的vipId礼包=" + vipIds
				+ ", 拉黑=" + pullBlack + ", 是否已领首充礼包=" + isGetFirstRechargeGift + ", 美人缠绵时间=" + beautyCardTime + ", 分区编号=" + serverId + ", 渠道=" + channel + ", 版本号=" + version + ", 添加时间=" + insertTime + ", 更新时间=" + updateTime + "]";
	}
}
