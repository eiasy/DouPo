...
public class InstPlayerRecharge implements Serializable {
	...
	public String toString() {
		return "到帐记录 [id=" + id + ", 角色编号=" + instPlayerId + ", openId=" + openId + ", 角色名=" + playerName + ", 渠道=" + channel + ", 本次充值人民币=" + thisrmb + ", 本次充值游戏币金额=" + thisamt + ", 累计充值游戏币金额=" + saveamt + ", 支付渠道=" + payChannel + ", 来源=" + source + ", 自有订单=" + orderId + ", 分区编号=" + serverId + ", 自有账号=" + accountId + ", 渠道订单=" + orderform + ", 角色等级=" + roleLevel + ", 道具编号=" + goodsId + ", 类型=" + ctype + ", 额度=" + money + "]";
	}
