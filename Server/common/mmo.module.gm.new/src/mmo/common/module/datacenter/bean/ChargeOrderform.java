...
public class ChargeOrderform {
	...
	public String toString() {
		return "订单信息 [ID=" + id + ", 订单号=" + orderform + ", 平台类型=" + gameId + ", 分区编号=" + serverId + ", 渠道=" + channelId + ", 包名=" + channelSub + ", 自有账号=" + accountId + ", OpenId=" + userId + ", 角色变化=" + roleId + ", 角色等级=" + roleLevel + ", 角色名=" + roleName + ", 道具编号=" + itemId + ", 道具名称=" + itemName + ", 单价=" + itemPrice + ", 数量=" + itemCount + ", OS=" + deviceOS + ", Imei=" + deviceImei + ", 更新时间=" + timeHandle + ", 状态=" + status + ", 创建时间=" + timeCreate + ", 过期时间=" + overtime + ", 设备序列号=" + deviceSerial + ", MAC=" + deviceMac + ", idfa=" + idfa + ", zoneId=" + zoneId + ", 充值应用=" + handleZoneId + "]";
	}
}
