...
public class Validate360Run extends HandRequestRun {
	...
	public void run() {
		try {
			...
			String url = ProjectCofigs.getParameter("360_normalUrl");
			...
			if (result != null && !result.equals("")) {
				...
				if (resultJson.containsKey("id") && !"".equals(resultJson.getString("id"))) {
