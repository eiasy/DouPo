package mmo.common.module.clazz.callback.doupo;
...
public class ValidateTencentDoupoRun implements IHttpRequest {
	...
	public ValidateTencentDoupoRun() {
		super();
	}
	...
	public boolean handle(AClientData clientData) {
		return false;
	}
