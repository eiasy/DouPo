...
public class ValidateVivoRun extends HandRequestRun {
	...
	public void run() {
		try {
			...
			String url = ProjectCofigs.getParameter("vivo_url");
			...
			String result = HttpsUtil.request(url, "");
			 ...
			 LoggerError.error("vivo result="+result);
			if (result != null && !result.equals("")) {
				JSONObject resultJson = JSONObject.fromObject(result);
				if (resultJson.containsKey("uid") && !"".equals(resultJson.getString("uid"))) {
					String id = resultJson.getString("uid");
