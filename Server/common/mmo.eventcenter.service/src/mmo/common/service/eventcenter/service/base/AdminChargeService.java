...
public class AdminChargeService {
	private static String selectCharge = "select id,eventSource,eventTag,appTag,platform,serverTag,channelTag,channelSub,accountId,userId,roleId,roleName,roleLevel,vipLevel,value1string,value2string,value3string,value4string,value5string,value6string,value7string,value8string,key1int,value1int,key2int,value2int,key3int,value3int,key1long,value1long,key1double,value1double,timeAdd from event_charge where ";

	public AdminChargeService() {
	}


	public List<EventDefault> getCharge(String platform, String serverTag, String eventTag, String value1string, String value4string, String value7string, String value8string, String channelTag, String channelSub, String userId, String roleName, String roleLevel, int start, int count, String startTime, String stopTime) {
		...
		try {
			...
			if (value1string != null && value1string.length() > 0) {
				...
				sb.append(" value1string='").append(value1string).append("' ");
			}
			if (value4string != null && value4string.length() > 0) {
				if (index++ > 0) {
					sb.append(" and ");
				}
				sb.append(" value4string='").append(value4string).append("' ");
			}
			if (value7string != null && value7string.length() > 0) {
				if (index++ > 0) {
					sb.append(" and ");
				}
				sb.append(" value7string='").append(value7string).append("' ");
			}
			if (value8string != null && value8string.length() > 0) {
				if (index++ > 0) {
					sb.append(" and ");
				}
				sb.append(" value8string='").append(value8string).append("' ");
			}
	...
	public int getCount(String platform, String serverTag, String eventTag, String value1string, String value4string, String value7string, String value8string, String channelTag, String channelSub, String userId, String roleName, String roleLevel, String start, String stop) {
		Connection conn = DBConnection.getConnection();
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
			StringBuilder sb = new StringBuilder();
			sb.append("select count(id) totalCount from event_charge where");
			int index = 0;
