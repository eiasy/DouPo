...
public class ChargeRecord {
	...
	public String toString() {
		return "ChargeRecord [id=" + id + ", orderId=" + orderId + ", gameId=" + gameId + ", serverId=" + serverId + ", accountId=" + accountId + ", roleId=" + roleId + ", rolename=" + rolename + ", money=" + money + ", getmoney=" + getmoney + ", ctype=" + ctype + ", state=" + state + ", atime=" + atime + ", dtime=" + dtime + ", note=" + note + "]";
	}
