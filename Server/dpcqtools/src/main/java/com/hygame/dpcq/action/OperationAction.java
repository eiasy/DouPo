...
public class OperationAction  extends ActionSupport{
	...
	public String getGoldMonthCardPname() {
		return goldMonthCardPname;
	}
	public void setGoldMonthCardPname(String goldMonthCardPname) {
		this.goldMonthCardPname = goldMonthCardPname;
	}
	public String getGoldMonthCardStartTime() {
		return goldMonthCardStartTime;
	}
	public void setGoldMonthCardStartTime(String goldMonthCardStartTime) {
		this.goldMonthCardStartTime = goldMonthCardStartTime;
	}
...
//		Channel channel = GameCoon.serverMap.get(serverid).getChannel();
	...
	public String recharge() throws Exception {
		...
		try {
			if (u == null) {
				LogUtil.info("recharge:user=huayi;rechargeWho=" + new String(playerName.getBytes("iso-8859-1"), "utf-8") + ";rechargeRmb=" + rmb);
			} else {
				LogUtil.info("recharge:user=" + u.getName() + ";rechargeWho=" + new String(playerName.getBytes("iso-8859-1"), "utf-8") + ";rechargeRmb=" + rmb);
			}
		} catch (Exception e) {
			LogUtil.error("充值写日志发生异常");
		}
	 ...
	 * 黄金月卡
	 * @author mp
	 * @date 2015-10-28 上午11:49:37
	 * @return
	 * @throws Exception
	 * @Description
	 */
	public String goldMonthCard() throws Exception {
		...
		//组织消息
		MessageData md = new MessageData();
		md.putStringItem("goldMonthCardPname", new String(goldMonthCardPname.getBytes("iso-8859-1"), "utf-8"));
		md.putStringItem("goldMonthCardStartTime", goldMonthCardStartTime);
		...
		LogUtil.info("goldMonthCard:user=" + u.getName() + ";goldMonthCardWho=" + new String(goldMonthCardPname.getBytes("iso-8859-1"), "utf-8") + ";goldMonthCardStartTime=" + goldMonthCardStartTime);
