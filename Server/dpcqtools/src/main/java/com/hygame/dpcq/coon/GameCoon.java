...
public class GameCoon {
	...
	public static Map<Integer, String> serverInfoMap = new  LinkedHashMap<Integer, String>();
		...
		if(channel == null){
			try {
				...
				try {
					...
					LogUtil.error("获取连接发生异常  ip=" + sa.getIp() + " port=" + sa.getPort() , e);
				}
