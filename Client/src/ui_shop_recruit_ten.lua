                ...
                if flag == 1 then
                    ...
                    if tag == 1 then
                        ...
                        if UIShopRecruitTen.time == 0 then
                            ...
                            UIManager.showToast("冷却时间未到，暂时不能兑换")
                        end
                    elseif tag == 3 then
                        --- 招募令招募
                        if recruitTokenNum <= 0 then
...
--            if param[3] then
--                local animation, animation_Name = ActionManager.getCardAnimation(param[3])
--                armature:getBone("hero02"):addDisplay(animation, 0)
--                armature:getBone("hero02"):setPositionY(20)
--                armature:getBone("hero"):addDisplay(card, 0)
--            else
--                armature:getBone("hero02"):addDisplay(card, 0)
--                armature:getBone("hero02"):setPositionY(-30)
--                armature:getBone("hero"):addDisplay(card, 0)
--                armature:getBone("hero"):setPositionY(20)
--            end
...
function UIShopRecruitTen.setup()
    ...
    if _isActivityRecruit then
        ...
        if flag == 2 then
            ...
            ui_butRight:getChildByName("text_down"):setVisible(false)
            text_hint:setVisible(false)
            leftPrice:setString("× " .. UIShop.recruitDiamondOnePrice)
            rightPrice:setString("× " .. UIShop.recruitTenPrice)
