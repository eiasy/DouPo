	...
	local function btnEvent(sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			for key, obj in pairs(childs) do
				...
				positionList = positionList .. instCardId .. "_" .. type .."_" .. position .. ";"
				if _curPositionList[obj:getTag()] ~= instCardId .. "_" .. type .. "_" .. position then
					isIdentical = false
				end
			end
...
function UILineupEmbattle.setup()
	...
	if net.InstPlayerFormation then
		...
		for key, obj in pairs(net.InstPlayerFormation) do
			...
			local _cruPosition = instCardId .. "_" .. type .. "_" .. position
		...
		ui_mainFlag:setString(string.format("（上阵%d人）", _teamCount))
		ui_benchFlag:setString(string.format("（上阵%d人）", _benchCount))
	end
end
