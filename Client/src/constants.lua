...
dp.rechargeGold = 0
dp.DictFightProp = { }
dp.DictFightProp[StaticFightProp.blood] = { sname = "根骨", value = 15 } -- 1根骨 ==> 15生命
dp.DictFightProp[StaticFightProp.wAttack] = { sname = "力量", value = 2.5 } -- 1力量 ==> 2.5物攻
dp.DictFightProp[StaticFightProp.wDefense] = { sname = "护甲", value = 1 } -- 1护甲 ==> 1物防
dp.DictFightProp[StaticFightProp.fAttack] = { sname = "智力", value = 2.5 } -- 1智力 ==> 2.5法功
dp.DictFightProp[StaticFightProp.fDefense] = { sname = "抗性", value = 1 } -- 1抗性 ==> 1法防
