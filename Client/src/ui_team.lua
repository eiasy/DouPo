...
function UITeam.setup()
	...
	for i = 1, (#formation1 + #formation2) do
		...
		if obj then
			...
			pageViewItem:getChildByName("image_card"):loadTexture("image/" .. DictUI[tostring(dictCardData.bigUiId)].fileName)
