...
int lua_cocos2dx_studio_ArmatureDataManager_addSpriteFrameFromMdFile(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ArmatureDataManager_addSpriteFrameFromMdFile'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccs.ArmatureDataManager:addSpriteFrameFromMdFile");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_ArmatureDataManager_addSpriteFrameFromMdFile'", nullptr);
            return 0;
        }
        cobj->addSpriteFrameFromMdFile(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "ccs.ArmatureDataManager:addSpriteFrameFromMdFile");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_ArmatureDataManager_addSpriteFrameFromMdFile'", nullptr);
            return 0;
        }
        cobj->addSpriteFrameFromMdFile(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.ArmatureDataManager:addSpriteFrameFromMdFile",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ArmatureDataManager_addSpriteFrameFromMdFile'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_studio_ArmatureDataManager(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ArmatureDataManager");
        tolua_function(tolua_S,"addSpriteFrameFromMdFile",lua_cocos2dx_studio_ArmatureDataManager_addSpriteFrameFromMdFile);
