...
int lua_cocos2dx_ui_Widget_releaseUpEvent(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Widget* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Widget_releaseUpEvent'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Widget_releaseUpEvent'", nullptr);
            return 0;
        }
        cobj->releaseUpEvent();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Widget:releaseUpEvent",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Widget_releaseUpEvent'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Widget_cancelUpEvent(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Widget* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Widget_cancelUpEvent'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Widget_cancelUpEvent'", nullptr);
            return 0;
        }
        cobj->cancelUpEvent();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Widget:cancelUpEvent",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Widget_cancelUpEvent'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Widget_pushDownEvent(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Widget* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Widget_pushDownEvent'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Widget_pushDownEvent'", nullptr);
            return 0;
        }
        cobj->pushDownEvent();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Widget:pushDownEvent",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Widget_pushDownEvent'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_Widget_moveEvent(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Widget* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Widget_moveEvent'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Widget_moveEvent'", nullptr);
            return 0;
        }
        cobj->moveEvent();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Widget:moveEvent",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Widget_moveEvent'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Widget(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Widget");
        ...
        tolua_function(tolua_S,"releaseUpEvent",lua_cocos2dx_ui_Widget_releaseUpEvent);
        ...
        tolua_function(tolua_S,"cancelUpEvent",lua_cocos2dx_ui_Widget_cancelUpEvent);
        ...
        tolua_function(tolua_S,"pushDownEvent",lua_cocos2dx_ui_Widget_pushDownEvent);
        tolua_function(tolua_S,"moveEvent",lua_cocos2dx_ui_Widget_moveEvent);
...
int lua_cocos2dx_ui_Text_getLabelRenderer(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Text* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Text_getLabelRenderer'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Text_getLabelRenderer'", nullptr);
            return 0;
        }
        cocos2d::Label* ret = cobj->getLabelRenderer();
        object_to_luaval<cocos2d::Label>(tolua_S, "cc.Label",(cocos2d::Label*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Text:getLabelRenderer",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Text_getLabelRenderer'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Text(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Text");
        ...
        tolua_function(tolua_S,"getLabelRenderer",lua_cocos2dx_ui_Text_getLabelRenderer);
...
int lua_cocos2dx_ui_Helper_seekNodeByTag(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ccui.Helper:seekNodeByTag");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Helper_seekNodeByTag'", nullptr);
            return 0;
        }
        cocos2d::Node* ret = cocos2d::ui::Helper::seekNodeByTag(arg0, arg1);
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.Helper:seekNodeByTag",argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Helper_seekNodeByTag'.",&tolua_err);
#endif
    return 0;
}
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Helper_seekNodeByName'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_ui_Helper(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Helper");
        tolua_function(tolua_S,"seekNodeByTag", lua_cocos2dx_ui_Helper_seekNodeByTag);
...
int lua_cocos2dx_ui_RichElementText_enableShadow(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichElementText_enableShadow'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "ccui.RichElementText:enableShadow");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichElementText_enableShadow'", nullptr);
            return 0;
        }
        cobj->enableShadow(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichElementText:enableShadow",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichElementText_enableShadow'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichElementText_enableOutline(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichElementText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichElementText_enableOutline'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "ccui.RichElementText:enableOutline");

        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ccui.RichElementText:enableOutline");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichElementText_enableOutline'", nullptr);
            return 0;
        }
        cobj->enableOutline(arg0, arg1);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichElementText:enableOutline",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichElementText_enableOutline'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichElementText_enableBold(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichElementText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichElementText_enableBold'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccui.RichElementText:enableBold");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichElementText_enableBold'", nullptr);
            return 0;
        }
        cobj->enableBold(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichElementText:enableBold",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichElementText_enableBold'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_RichElementText_enableUnderline(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichElementText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichElementText_enableUnderline'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccui.RichElementText:enableUnderline");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichElementText_enableUnderline'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichElementText:enableUnderline",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichElementText_enableUnderline'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichElementText_setGradientColor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichElementText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichElementText_setGradientColor'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "ccui.RichElementText:setGradientColor");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichElementText_setGradientColor'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichElementText:setGradientColor",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichElementText_setGradientColor'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_RichElementText(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"RichElementText");
        ...
        tolua_function(tolua_S,"enableShadow",lua_cocos2dx_ui_RichElementText_enableShadow);
        tolua_function(tolua_S,"enableOutline",lua_cocos2dx_ui_RichElementText_enableOutline);
        tolua_function(tolua_S,"enableBold",lua_cocos2dx_ui_RichElementText_enableBold);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichElementText_init);
        tolua_function(tolua_S,"enableUnderline",lua_cocos2dx_ui_RichElementText_enableUnderline);
        tolua_function(tolua_S,"setGradientColor",lua_cocos2dx_ui_RichElementText_setGradientColor);
