...
#ifndef pluginChannel_h
#define pluginChannel_h
...
public:
    ...
    void submitLoginGameRole();
   	...
   	//支付系统功能
    void pay(std::string productID , std::string userData , std::string productName , std::string productPrice , std::string productCount , std::string roleId , std::string roleName , std::string roleGrade , std::string serverId );
